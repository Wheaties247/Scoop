...
function deleteComment(url, request) {
  ...
  if (savedComment) {
    ...
    database.users[savedComment.username].commentIds.splice(userIndex.indexOf(id), 1);
    
    const articleIndex = database.articles[savedComment.articleId].commentIds;
    database.articles[savedComment.articleId].commentIds.splice(articleIndex.indexOf(id), 1);
